...
<div class="container-fluid">
	...
	<h1 class="h3 mb-0 text-gray-800 mb-4">Criteria Graph</h1>
	<p class="mb-2">${studentData.centerName } > ${studentData.className } > ${studentData.studentName } </p>

	<form id="criteriaForm" name="criteriaForm" class="form-inline mr-auto w-100 navbar-search justify-content-end" onsubmit="return false;">
		<input type="hidden" name="studentSeq" value="${studentData.studentSeq }">
		<div class="input-group mr-4">
			<select class="form-control" name="domainSeq">
				<option value="">영역 전체선택</option>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">크리테리아 그래프</h6>
		</div>
...
<script src="../script/dct/criteriaChart.js"></script>
